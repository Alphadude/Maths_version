...
public class AlcStep4Fragment extends Fragment {
    //These variables are used to display the fragments
    Fragment frag;
    FragmentTransaction fragTransaction;


    public AlcStep4Fragment() {
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstance) {
        ...
        text1.setText(R.string.alc_step4_text);

        text2.setText("1050, 1100, 1200... 1450, 1500");
        text3.setText("1550, 1600, 1650... 1950, 2000");
