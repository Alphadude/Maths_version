...
public class IlcTest2InstructionFragment extends Fragment {
    //These variables are used to display the fragments
    Fragment frag;
    FragmentTransaction fragTransaction;


    public IlcTest2InstructionFragment() {
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstance) {
        ...
        tv1.setText(R.string.ilc_test_instruction_text1);

        tv2.setText(R.string.ilcTestInstruction_text2);
