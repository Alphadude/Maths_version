...
public class AlcStep6Fragment extends Fragment {
    //These variables are used to display the fragments
    Fragment frag;
    FragmentTransaction fragTransaction;


    public AlcStep6Fragment() {
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstance) {
        ...
        text1.setText(R.string.alc_step6_text);

        text2.setText("150,000, 200,000, 250,000... 450,000, 500,000");
        text3.setText("550,000, 600,000, 650,000... 950,000, 1,000,000");
